...
<details>
  ...
  a. A 1-day old term baby weighing 2.2 kg with jaundice of the sclera,
  temperature 37.4 C and is able to feed.
</details>
...
<details>
  <summary>Check Answer</summary>
  d. Use of high flow rate like 4litres per minute with nasal prongs can
  work for infants but with a higher risk for abdominal distension
</details>
...
<details>
  <summary>Check Answer</summary>
  c. The process of clinical audit starts with; Audit of files/notes, and
  then identify problems, action plan and finally action by the team
</details>
...
b. Extension of the neck so that the jaw faces the ceiling using the head tilt chin lift manocuvre is recommended for children aged one year and below.
...
<details>
  <summary>Check Answer</summary>
  a. Oro-pharyngeal (Guedel) airways can be used in an unresponsive child
...
a. Use light at 220- 320nm wavelength

b. Increasing the light source wavelength

c. Use of light at 420-470nm wavelength

d. Reducing the light source wavelength

e. Use of light at 320-420nm wavelength
...
<details>
  <summary>Check Answer</summary>
  a. Give up to 2 boluses of Ringer's lactate rapidly for hypovolemic shock
  secondary to diarrhea and vomiting
</details>

### Question 36

A 1-year-old child has been brought to Emergency Room with no signs of life. The most appropriate sequence in the initial management of this child is,
...
<details>
  <summary>Check Answer</summary>
  d. Shout for Help, Position Airway in Sniffing position, assess Breathing
  and Give 5 rescue breaths, rapidly assess central pulse and start CPR
  at 30:2. ? Assume 1 rescuer.
</details>
...
d. Give an IV bolus of 20ml of 10% dextrose
...
<details>
  <summary>Check Answer</summary>
  c. Weight for length Z scores can be used in infants less than 6 months
  of age
</details>
...
<details>
  <summary>Check Answer</summary>
  d. The first minute of life is to be spent on uninterrupted positive
  pressure ventilation if the baby fails to establish breathing after birth
</details>
...
<details>
  <summary>Check Answer</summary>
  b. Formula feeds have lower risk of necrotizing enterocolitis compared
  to breast milk
</details>
...
a. Dosages for drugs and fluids/feeds should be prescribed using body surface area

b. Weight should be checked twice a week
...
c. Continue IV 10% dextrose infusion
