...
WHO recommends at least 8 ANC contacts and first visit as soon as possible in first trimester
...
Within this model, the word “contact” has been used instead of “visit”, as it implies an active connection between a pregnant woman and a health-care provider that is not implicit with the word “visit”. 
...
Maternal nutrition: avoidance of large, fatty meals and alcohol, cessation of smoking, and raising the head of the bed to sleep.
