...
- The proportion of live births supported by a skilled provider has risen significantly over the past two decades.

<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img src="https://i.imgur.com/n5cGysi.jpg" alt="kdhs-2022" />
</div>
...
### Prevention & Control of Neonatal Morbidity/Mortality
