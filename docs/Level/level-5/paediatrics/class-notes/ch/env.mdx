...
1. Inadequate access (very high risk)
- The collection time is 30min or more or within a distance of more than 1km. 
- Very low amounts hence compromising hygiene.
- Basic access (high risk)
- Collected within 5-30 min or at a distance of between 100m-1km.
- This is approximately 20L per person per day therefore hygiene is compromised

2. Intermediate access (medium risk)
- In this case water is provided by one tap within a distance of 100m and 5min collection time. 
- This is approximately 50L per person per day. 
- For hygiene purposes it’s fine but inadequate if there is an outbreak
- Optimal access (Low risk)
- Supply is from multiple taps within the house. Approximately 100L PPPD. 
