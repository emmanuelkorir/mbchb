...
A para 1+0 now (2 marks) with (obstetric Fistula (a vesicovaginal fistula) (2 marks) most probably due to Obstructed Labour (2 marks)
...
2. What additional history would you obtain from Mwikali? (total 20 marks) (Any 10 @ 2 marks each)
...
5. Describe the classification used for the above condition. (total 10 marks - 1 mark each)

<details>
<summary>Check Answer</summary>

Anatomic Classification - also known as Kees Waaldijk classification

- Type I: Not involving the closing mechanism
...
- B: Involving (sub)total urethra
  - a: without circumferential defect
- b: with circumferentiai defect 
- Type III: Miscellaneous, eg ureteric fistula
