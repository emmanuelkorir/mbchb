...
<p>biodata:</p>
<ul>
  <li>Last known menstrual period</li>
</ul>
<p>HPI, family history, sexual history:</p>
<ul>
  <li>Characterize the bleeding: amount, colour, any clots, pads filled.</li>
  <li>Symptoms of anemia from blood loss: fatigue, dizziness, palpitations.</li>
  <li>Bleeding tendencies: epistaxis, easy bruising.</li>
  <li>Family history of bleeding tendencies, prolonged menstrual bleeding.</li>
  <li>Intermenstrual bleeding or spotting.</li>
  <li>Usual menstrual periods, how long they last, if heavier at the beginning or towards the end, dysmenorrhoea.</li>
  <li>Contraception use, and type, and when last used and if compliant especially hormonal.</li>
  <li>Any medication taken for long periods, especially hemostatic e.g., heparin, warfarin.</li>
  <li>Symptoms of thyroid dysfunction: cold or heat intolerance, fatigue, lethargy, anxiety, weight gain, weight loss.</li>
  <li>Voluntary sexual history, with last engagement.</li>
  <li>History of sexual trauma e.g., rape.</li>
  <li>Suspecting infection? fever, discharge, odor.</li>
  <li>Abortion procedure, where, when, MVA, D and C.</li>
  <li>Liver: pruritus, yellowing of the eyes</li>
</ul>
</details>
...
- Lethargy, fatigue, jaundice, pallor, pruritus, oedema, lymph nodes, ecchymosis

- Vitals: tachycardia, tachypnea, fever

- Pulse: bounding, haemic

Abdomen:

- Inspection: distended, tender, ascites, prominent vessels.

Pelvic: sterile speculum exam, vaginal exam, bimanual exam, bleeding, discharge, any obvious mass, bulky uterus, pelvic mass or cyst.

CVS:

- Haemic murmur due to anemia
...
<summary>Check Answer</summary>
<ul>
  <li>Pregnancy related: abortions, ectopic pregnancy.</li>
  <li>Coagulation disorders: VWF disease.</li>
</ul>
</details>
...
<p>Labs:</p>
<ul>
  <li>Pregnancy test, serum HCG.</li>
  <li>TBC, PBF.</li>
  <li>Serum ferritin, total iron.</li>
  <li>APTT, VWF.</li>
  <li>Hormonal assays: TSH, prolactin, progresterone, DHEAS, testosterone, LH, FSH, Estrogen.</li>
</ul>
<p>Imaging:</p>
<ul>
  <li>Transvaginal ultrasonography for PALM causes.</li>
  <li>Sonohysterogram - to diagnose polyps, submucous leimyomas.</li>
  <li>Pelvic MRI.</li>
  <li>Diagnostic hysterescopy +/- biopsy.</li>
  <li>Abdominopelvic CT and MRI.</li>
  <li>CXR: rule out metastasis .</li>
</ul>
</details>
...
- Address anemia, acute blood loss: IV fluids, transfusion, hematinics

- Management cormobidity, infection

- Analgesia

- Manage specific cause: resuscitation, supportive, conservative and definitive according to cause. 

pharmacological
1. Acute bleeding
- high dose IV estrogen which acts on endometrium to stimulate rapid growth that stems bleeding
- others: oral progestins, OCPs, tranexamic acid

2. Ovulatory:
- OCPs, progestins oral, IV or an IUD
- NSAIDS can reduce blood loss
- tranexamic acid

3. Anovulatory where there is unopposed estrogen
- progrestins oral or IUD which induces withdrawal bleeding
- oral contraceptive pills

4. Desmopressin for von willebrand disease
...
Estrogen progesterone pills. A follow-up pregnancy test at four weeks should be offered to all women who return,
...
Hepatitis B vaccination - is intended to provide protection from future Hepatitis B virus infection. 1st dose at first contact, second at 1 month, third at 6 months.
