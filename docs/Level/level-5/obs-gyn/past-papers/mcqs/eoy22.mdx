...
D. Morphine/ pethidine will be administered st inl stage of labour 
...
C. She is probab y going to have twins. 
...
A. Very low birthweight (VLBW) is defined as BW less than 1000 g. 
...
D. Down's syndrome babies have a higher than expected birthweight but tend not to grow as tall as their peers during childhood. 

E. Preterm Il-JGR babies should be fed 150- 165 mL/g of high-calorie milk from birth to prevent hypoglycaemia. 
...
B. Seizure frequency In creases in approximately 70% of women 
...
Which ofthe following is true of small for gestational age (SGA) babies? 
