...
Is an online library of evidence-informed guidelines for nutrition interventions;
The content is regularly reviewed for necessary updates; Is updated with new interventions every 3-4 
months.

Intervention
In WHO’s e-Library of evidence of nutrition actions, the interventions are grouped by:
- Type;
- Category

Interventions by type:
- Behavioral interventions focus on the adjustment of personal practices and habits.
- Fortification: adding nutrients to staple foods

WHOs classification of interventions by Type
- Supplementation: refers to the provision of individual or mixtures of nutrients separately from 
the diet.
- Regulatory interventions are those aimed at regulating certain nutrition-related activities or 
actions which have an impact on nutrition and health outcomes.
-  Situational health actions: Are nutrition interventions that take place in a specific setting

WHOs classification of Interventions by category

Three groups are available, based on level of guidance and supporting evidence;

- Category 1: Have recently approved guidelines by WHO Guidelines Review Committee or 
supported by recommendations and other forms of guidance from the World Health 
Assembly.
- Category 2: Have systematic review(s) conducted but no recent guidelines approved by WHO 
available
-  Category 3 interventions have limited available evidence, with no systematic reviews 
documented.

Category 1 and category 2 nutrition interventions are the ones recommended by WHO. For Category 
3, Further research is recommended as well as systematic review