...
.
**Law of supply:** Is the relationship between supply and price; other things remaining the same, when price rises, supply increases and when price falls, supply decreases. Price and quantity vary directly. When price changes, supply also changes.

<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img src="https://i.imgur.com/pWcv1em.png" alt="supply" />
</div>
...
Elasticity of supply measures the response of quantity supplied to changes in any of the variables that influence it.

The **elasticity of supply** is defined as the percentage change in quantity supplied divided by the percentage change in price that brought it about.

<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img src="https://i.imgur.com/IqSQG9a.png" alt="esupply" />
</div>
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img src="https://i.imgur.com/GVhQJla.png" alt="inelastic" />
</div>
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img src="https://i.imgur.com/2SJWgY4.png" alt="infinite" />
</div>
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img src="https://i.imgur.com/cQChlOb.png" alt="unity" />
</div>
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img src="https://i.imgur.com/xVLh6z1.png" alt="elastic" />
</div>
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img src="https://i.imgur.com/KIZnCyp.png" alt="inelastic-supply" />
</div>

## Concepts of price theory

Price theory is concerned with the determination of price of any commodity. It is determined by putting demand and supply curves together. Price is determined at the level where demand for and supply of any commodity are equal referred to as **equilibrium price.**

## Price Equilibrium

**Equilibrium price** is that price at which the quantity offered for sale equals the quantity demanded by consumers. At the equilibrium price, quantity demanded equals quantity supplied, with no shortages or surpluses.

<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img
    src="https://i.imgur.com/N3OxCQl.png"
    alt="price-equilibrium"
  />
</div>

**Rationing function of prices:**

The tendency of prices, determined by the interaction of supply and demand, to clear the market is referred to as the rationing function of prices:

- Functioning prices automatically rations the production of
  the buyers leaving no shortage or surplus
- The shifts in the demand or supply curves lead to a change
  in equilibrium price and quantity
- It ensures that market price prevails and that no single
  participant in the market take advantage of another

## Concepts of competition

Competition is determined by the number of buyers and sellers existing in health economy.

If a seller’s price is perceived a too high, buyers will seek others who are willing to sell at a lower price, thereby forcing the initial seller to lower the price or risk returning home with unsold goods/services.

If a seller’s price is perceived a too high, buyers will seek others who are willing to sell at a lower price, thereby forcing the initial seller to lower the price or risk returning home with unsold goods/services.

Similarly, no single buyer can force a seller to sell below market price if there are other buyers willing to pay the higher market price
...
## The determinants of consumer demand for health care

Consumer choice looks more closely at the determinants of consumer demand

- Willingness to pay
- Ability to pay
- The demand is always at a price

### Indifference curve

Consumer choice shows how indifference curves can be used to describe consumers’ tastes and then introduce a budget line to describe the consumption possibilities open to a consumer who has a given income.
...
Consumers will maximize their overall satisfaction when the marginal utility per pound spent is equal for all products purchased.

To maximize utility consumers allocate spending between products so that equal utility is derived from the last unit of money spent on each.
