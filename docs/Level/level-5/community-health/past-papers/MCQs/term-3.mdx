...
B. Currently there no evidence suggesting that it can be transmitted ov persons who are asymptomatic
...
C D. COVID-19 infection is easily transmissible from person to person
